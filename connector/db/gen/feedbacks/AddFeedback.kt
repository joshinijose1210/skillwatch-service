...
class AddFeedbackParamSetter : ParamSetter<AddFeedbackParams> {
  override fun map(ps: PreparedStatement, params: AddFeedbackParams) {
    ...
    ps.setObject(6, params.isDraft)
  }
}

data class AddFeedbackResult(
  val srNo: Long,
...
class AddFeedbackRowMapper : RowMapper<AddFeedbackResult> {
  override fun map(rs: ResultSet): AddFeedbackResult = AddFeedbackResult(
...
class AddFeedbackQuery : Query<AddFeedbackParams, AddFeedbackResult> {
  ...
  override val mapper: RowMapper<AddFeedbackResult> = AddFeedbackRowMapper()

  override val paramSetter: ParamSetter<AddFeedbackParams> = AddFeedbackParamSetter()
}

...
data class AddExternalFeedbackRequestParams(
...
class AddExternalFeedbackRequestParamSetter : ParamSetter<AddExternalFeedbackRequestParams> {
  override fun map(ps: PreparedStatement, params: AddExternalFeedbackRequestParams) {
    ...
    ps.setObject(5, params.isExternalRequest)
  }
}

data class AddExternalFeedbackRequestResult(
  val id: Long,
  val requestedBy: Long,
  val feedbackTo: Long,
...
class AddExternalFeedbackRequestRowMapper : RowMapper<AddExternalFeedbackRequestResult> {
  override fun map(rs: ResultSet): AddExternalFeedbackRequestResult =
      AddExternalFeedbackRequestResult(
...
class AddExternalFeedbackRequestQuery : Query<AddExternalFeedbackRequestParams,
    AddExternalFeedbackRequestResult> {
  ...
  override val mapper: RowMapper<AddExternalFeedbackRequestResult> =
      AddExternalFeedbackRequestRowMapper()

  override val paramSetter: ParamSetter<AddExternalFeedbackRequestParams> =
      AddExternalFeedbackRequestParamSetter()
}

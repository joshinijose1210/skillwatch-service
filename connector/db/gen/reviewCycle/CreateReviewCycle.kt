...
data class CreateReviewCycleParams(
  val start_date: Date?,
  val end_date: Date?,
  val publish: Boolean?,
...
class CreateReviewCycleParamSetter : ParamSetter<CreateReviewCycleParams> {
  override fun map(ps: PreparedStatement, params: CreateReviewCycleParams) {
...
data class CreateReviewCycleResult(
  val id: Long,
  val startDate: Date,
  val endDate: Date,
  val publish: Boolean,
...
class CreateReviewCycleRowMapper : RowMapper<CreateReviewCycleResult> {
  override fun map(rs: ResultSet): CreateReviewCycleResult = CreateReviewCycleResult(
...
class CreateReviewCycleQuery : Query<CreateReviewCycleParams, CreateReviewCycleResult> {
  ...
  override val mapper: RowMapper<CreateReviewCycleResult> = CreateReviewCycleRowMapper()

  override val paramSetter: ParamSetter<CreateReviewCycleParams> = CreateReviewCycleParamSetter()
}

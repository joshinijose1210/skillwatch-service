...
data class GetEmployeesWithInCompletedManagerReviewsParams(
  val reviewCycleId: Long?,
  val managerId: Long?,
  val organisationId: Long?
)

class GetEmployeesWithInCompletedManagerReviewsParamSetter :
    ParamSetter<GetEmployeesWithInCompletedManagerReviewsParams> {
  override fun map(ps: PreparedStatement, params: GetEmployeesWithInCompletedManagerReviewsParams) {
    ...
    ps.setObject(6, params.managerId)
    ps.setObject(7, params.managerId)
  }
}

data class GetEmployeesWithInCompletedManagerReviewsResult(
  val organisationId: Long,
  val id: Long,
...
class GetEmployeesWithInCompletedManagerReviewsRowMapper :
    RowMapper<GetEmployeesWithInCompletedManagerReviewsResult> {
  override fun map(rs: ResultSet): GetEmployeesWithInCompletedManagerReviewsResult =
      GetEmployeesWithInCompletedManagerReviewsResult(
...
class GetEmployeesWithInCompletedManagerReviewsQuery :
    Query<GetEmployeesWithInCompletedManagerReviewsParams,
    GetEmployeesWithInCompletedManagerReviewsResult> {
  override val sql: String = """
      ...
      |WHERE
      |  employees.organisation_id = ?
      |  AND ((firstManagerMapping.manager_id = ? AND firstManagerMapping.emp_id != ?) OR
  ...
  override val mapper: RowMapper<GetEmployeesWithInCompletedManagerReviewsResult> =
      GetEmployeesWithInCompletedManagerReviewsRowMapper()

  override val paramSetter: ParamSetter<GetEmployeesWithInCompletedManagerReviewsParams> =
      GetEmployeesWithInCompletedManagerReviewsParamSetter()
}

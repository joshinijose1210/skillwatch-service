...
export declare class OperatorExpression extends TFExpression {
    ...
    private left;
    private right?;
    constructor(operator: Operator, left: Expression, right?: Expression | undefined);
    resolve(context: IResolveContext): string;
}
...
declare class ForExpression extends TFExpression {
    ...
    constructor(input: Expression, valueExpression: Expression, keyExpression?: Expression | undefined);
    resolve(context: IResolveContext): string;
}
/**
